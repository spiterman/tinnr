...
var apiInfoAPI_ID = process.env.YUMMLY_API_ID;
var apiInfoAPI_KEY = process.env.YUMMLY_API_KEY;

module.exports = {
  getRecipes: function(req, res, next) {
    // insert api id and api password
    var YUMMLY_API_ID = apiInfoAPI_ID;
    var YUMMLY_API_KEY = apiInfoAPI_KEY;
